...
import com.gumio_inf.aacsampleapp.model.api.CheeseApi
import com.gumio_inf.aacsampleapp.model.db.CheeseDatabase
                    ...
                    instance
                            ?: CheeseRepository(
                                    Room.databaseBuilder(
                                            context, CheeseDatabase::class.java, "cheese.db"
                                    ).build(),
                                    CheeseApi(),
